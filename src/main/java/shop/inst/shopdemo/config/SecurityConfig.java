    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/notices", "/api/notices/*", "/api/notices/banner").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/seller/settlements", "/api/seller/settlements/available").hasRole("SELLER")
                        .requestMatchers(HttpMethod.POST, "/api/seller/settlements/request").hasRole("SELLER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/goods/*/purchase").authenticated()
