    ...
    <div className="max-w-md mx-auto mt-10">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs text-gray-400 font-medium">또는 직접 가입</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="p-3 bg-indigo-50 border border-indigo-100 rounded-xl text-xs text-indigo-600">
            가입 후 <strong>판매자 신청</strong>을 통해 판매 기능을 이용할 수 있습니다.
          </div>
